...
public class Plum4Check {
	...
	protected void clickAndCaptureFromHome(WebDriver driver, WebDriverWait wait, String saveFolder)
		...
		//クリック対象要素が表示されるまで待つ（サービス：Serviceタイトル）
		wait.until(ExpectedConditions
		...
		captureUtil.cupturePage(driver, saveFolder, "梅アイコンからサービス");
		...
		//キャプチャー
		captureUtil.cupturePage(driver, saveFolder, "梅アイコンからサービススクロール後");
